				...
				<div class="col-lg-5 col-md-8 single-right-left ">
					<div class="grid images_3_of_2">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/<?php echo $row_chitiet['sanpham_anhchitiet'] ?>">
									<div class="thumb-image">
										<img src="images/<?php echo $row_chitiet['sanpham_anhchitiet'] ?>" data-imagezoom="true" class="img-fluid" alt=""> </div>
								</li>
						...
						<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
							<form action="?quanly=giohang" method="post">
								<fieldset>
									...
									<input type="submit" name="themgiohang" value="Thêm Giỏi Hàng" class="button" />
								</fieldset>
							</form>
						</div>
					</div>
