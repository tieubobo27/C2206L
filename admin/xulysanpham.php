...
<?php
	if(isset($_POST['themsanpham'])){
		...
		$hinhanhchitiet = $_FILES['hinhanhchitiet']['name'];
		...
		$hinhanhchitiet_tmp = $_FILES['hinhanhchitiet']['tmp_name'];
		$sql_insert_product = mysqli_query($con,"INSERT INTO tbl_sanpham(sanpham_name,sanpham_chitiet,sanpham_mota,sanpham_gia,sanpham_giakhuyenmai,sanpham_soluong,sanpham_image,category_id,sanpham_anhchitiet) values ('$tensanpham','$chitiet','$mota','$gia','$giakhuyenmai','$soluong','$hinhanh','$danhmuc','$hinhanhchitiet')");
		move_uploaded_file($hinhanh_tmp,$path.$hinhanh);
		move_uploaded_file($hinhanhchitiet_tmp,$path.$hinhanhchitiet);
		...
		$path = '../uploads/';
		if($hinhanh==''){
			$sql_update_image = "UPDATE tbl_sanpham SET sanpham_name='$tensanpham',sanpham_chitiet='$chitiet',sanpham_mota='$mota',sanpham_gia='$gia',sanpham_giakhuyenmai='$giakhuyenmai',sanpham_soluong='$soluong',category_id='$danhmuc',sanpham_anhchitiet=$hinhanhchitiet WHERE sanpham_id='$id_update'";
		}else{
			move_uploaded_file($hinhanh_tmp,$path.$hinhanh);
			move_uploaded_file($hinhanhchitiet_tmp,$path.$hinhanhchitiet);
			$sql_update_image = "UPDATE tbl_sanpham SET sanpham_name='$tensanpham',sanpham_chitiet='$chitiet',sanpham_mota='$mota',sanpham_gia='$gia',sanpham_giakhuyenmai='$giakhuyenmai',sanpham_soluong='$soluong',sanpham_image='$hinhanh',category_id='$danhmuc',sanpham_anhchitiet='$hinhanhchitiet' WHERE sanpham_id='$id_update'";
		}
		...
		<?php
			if(isset($_GET['quanly'])=='capnhat'){
				...
				<form action="" method="POST" enctype="multipart/form-data">
					...
					<img src="../uploads/<?php echo $row_capnhat['sanpham_anhchitiet'] ?>" height="80" width="80"><br>
					<label>Giá</label>
			...
			<div class="col-md-8">
				...
				<table class="table table-bordered ">
					...
					<tr>
						...
						<td><img src="../uploads/<?php echo $row_sp['sanpham_anhchitiet'] ?>" height="100" width="80"></td>
